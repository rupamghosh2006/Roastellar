...
**Route Protection:** `/metrics` is an auth-protected route (login required).

![Metrics Dashboard](https://res.cloudinary.com/ddp0nf4uv/image/upload/v1777566860/Screenshot_2026-04-30_220312_yi4zmq.png)
